...
def main(unused_argv):
  ...
  #   int(i) for i in input_region.split(',')]
  # offset_xyz = np.array((offset_x, offset_y, offset_z))
  # size_xyz = np.array((size_x, size_y, size_z))
  ...
  predictions = mask_estimator.predict(
    input_fn=lambda: io_utils.predict_input_fn_precomputed(
